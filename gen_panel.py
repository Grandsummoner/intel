"""Shared text-to-vector-path helper, copied verbatim from Stellar's own
gen_panel.py -- same family, same exact glyph-path technique, not a
reimplementation. NanoSVG (VCV Rack's panel parser) doesn't render <text>,
only vector shapes, so every label on every panel in this family goes
through this."""
